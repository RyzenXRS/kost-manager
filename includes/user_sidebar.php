        ...
        <div>
            ...
            <ul class="nav-links">
                ...
                <li onclick="window.location='kamar_saya.php'" class="<?= basename($_SERVER['PHP_SELF']) == 'kamar_saya.php' ? 'active' : '' ?>">
                    <i class="fas fa-bed"></i> Kamar Saya</li>
                <li><i class="fas fa-users"></i> Teman Kost</li>
                <li><i class="fas fa-wallet"></i> Pembayaran</li>
                <li><i class="fas fa-file-invoice-dollar"></i> Tagihan</li>
                <li><i class="fas fa-chart-line"></i> Riwayat</li>
            </ul>
        </div>
